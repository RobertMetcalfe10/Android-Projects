...
public class UserFeedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final LinearLayout linearLayout=(LinearLayout)findViewById(R.id.linearVertical);

        Intent intent=getIntent();

        String activeUser=intent.getStringExtra("usernames");

        setTitle(activeUser+"'s Feed");

        ParseQuery<ParseObject> parseQuery= new ParseQuery<>("Images");

        parseQuery.whereEqualTo("username",activeUser);
